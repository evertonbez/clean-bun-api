...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "src/infra/database/generated/prisma",
    "infra/database/generated/prisma",
  ]
...
path.join(process.cwd(), "src/infra/database/generated/prisma/libquery_engine-debian-openssl-3.0.x.so.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "src/infra/database/generated/prisma/schema.prisma")
